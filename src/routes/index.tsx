          ...
          <div className="relative grid gap-8 lg:grid-cols-[1.25fr_0.95fr] lg:items-stretch">
            ...
            <div className="flex h-full flex-col rounded-[28px] px-6 py-6 md:px-7 md:py-7 backdrop-blur-sm" style={{ background: 'linear-gradient(135deg, rgba(242,250,248,0.96) 0%, rgba(230,245,240,0.94) 100%)', border: '1px solid rgba(255,255,255,0.38)', boxShadow: '0 12px 28px rgba(8,35,40,0.12)' }}>
              ...
              <p className="text-base md:text-[19px] font-semibold" style={{ color: '#16313A', lineHeight: '1.7' }}>
                It is not clearly understood what members truly want, value, or are willing to pay for.
              </p>
            ...
            <div className="card-hover rounded-[28px] border border-[#0D7377]/10 bg-gradient-to-br from-[#EAF8F7] via-white to-[#F7FDFC] p-6" style={{ boxShadow: '0 12px 26px rgba(16,39,52,0.06)' }}>
              ...
              <div className="space-y-4 text-sm md:text-[15px]" style={{ color: '#5C6B78', lineHeight: '1.8' }}>
                {[
                  ...
                  'Understanding what the Alliance is made for',
  ...
  return (
    <section id="recommendations" className="section-pad bg-white">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-14 grid items-start gap-8">
          {recs.map((rec, i) => {
            ...
            >
              ...
              <div className="flex h-full flex-col md:flex-row">
                <div className={`p-6 md:p-8 flex-1 ${isOpen ? '' : 'flex min-h-[148px] items-center'}`}>
                  ...
                  {rec.number === 4 ? (
                    <div className="mt-5 pt-5" style={{ borderTop: '1px solid rgba(20,189,172,0.16)' }}>
                    ...
                    <div className="rounded-[22px] border p-5" style={{ background: 'linear-gradient(160deg, rgba(255,255,255,0.99) 0%, rgba(20,189,172,0.08) 100%)', borderColor: 'rgba(20,189,172,0.18)', boxShadow: '0 10px 22px rgba(16,39,52,0.04)' }}>
                      <div className="flex items-center gap-3 mb-5">
                        ...
                        <div>
                          ...
                          <h4 className="font-bold text-base" style={{ color: '#1A2332' }}>Turning Strategy into Action</h4>
                        </div>
                      </div>
